...
ggsave(file.path(deseq_output_dir, "lollipop_year.pdf"),     p_loll_year, width = 8, height = 8, dpi = 300, device = cairo_pdf)
ggsave(file.path(deseq_output_dir, "lollipop_sediment.pdf"), p_loll_sed,  width = 8, height = 8, dpi = 300, device = cairo_pdf)
ggsave(file.path(deseq_output_dir, "lollipop_methane.pdf"),  p_loll_meth, width = 8, height = 6, dpi = 300, device = cairo_pdf)
ggsave(file.path(deseq_output_dir, "lollipop_site.pdf"),     p_loll_site, width = 8, height = 6, dpi = 300, device = cairo_pdf)
