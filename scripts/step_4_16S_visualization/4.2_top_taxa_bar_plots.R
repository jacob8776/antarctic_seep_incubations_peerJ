...
ggsave(file.path(supplementary_dir, "FigureS3_ar_rank_16s.png"),  plot = p_ar_rank_16s,  scale = 1, width = 10, height = 7, dpi = 600)
ggsave(file.path(supplementary_dir, "FigureS2_bac_rank_16s.pdf"), plot = p_bac_rank_16s, scale = 1, width = 10, height = 7, dpi = 600, device = cairo_pdf)
ggsave(file.path(supplementary_dir, "FigureS3_ar_rank_16s.pdf"),  plot = p_ar_rank_16s,  scale = 1, width = 10, height = 7, dpi = 600, device = cairo_pdf)
