...
# abundance across samples, faceted by year, with location + metabolism
# annotation bars. Saves methanotrophs_genus_updated_jun21.png.
...
ggsave(
  filename = file.path(figures_dir, "Figure5_methanotrophs_genus.png"),
