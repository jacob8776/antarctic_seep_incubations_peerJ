...
OUTPUT_DIR="/home/micro/wynneja/jacob/metagenome_experiments/antarctica_experiments/kaiju_annotation/short_annotations/family_summaries" # Change this to your desired output folder path

# Define the common database files path
NODES_DMP="../kaiju_annotation/nodes.dmp"
NAMES_DMP="../kaiju_annotation/names.dmp"
RANK="family" # The taxonomic rank to summarize
...
do
    ...
    if [ -f "$INFILE_PATH" ]; then
        ...
        echo "kaiju2table -t $NODES_DMP -n $NAMES_DMP -r $RANK -o $OUTFILE_PATH $INFILE_PATH"
