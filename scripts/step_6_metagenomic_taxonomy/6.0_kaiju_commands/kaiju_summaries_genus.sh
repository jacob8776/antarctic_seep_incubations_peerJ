...
OUTPUT_DIR="/home/micro/wynneja/jacob/metagenome_experiments/antarctica_experiments/kaiju_annotation/short_annotations/genus_summaries" # Change this to your desired output folder path
